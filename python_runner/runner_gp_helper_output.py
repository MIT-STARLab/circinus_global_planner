...
def  plot_activity_scheduling_results ( gp_runner_inst,all_possible_winds,sel_routes_by_obs,sched_routes,energy_usage,data_usage,ecl_winds,metrics_plot_inputs):
    ...
    gp_runner_inst.gp_plot.gp_plot_all_sats_acts(
        ...
        base_time_dt = gp_runner_inst.gp_inst_planning_params['planning_start_dt'],
        # plot_title = 'GP-Fast: RS (possible) and AS (scheduled) Activities',
        plot_title = 'GP-Opt: Scheduled Activities',
        plot_size_inches = (18,9),
    ...
    gp_runner_inst.gp_plot.plot_energy_usage(
        ...
        gp_runner_inst.gp_inst_planning_params['planning_end_dlnk_dt'],
        # base_time = gp_runner_inst.scenario_params['start_utc_dt'],
        base_time = gp_runner_inst.gp_inst_planning_params['planning_start_dt'],
        # plot_title = 'Energy Storage Utilization',
        # plot_title = 'GP-Fast: Scheduled Energy Storage Utilization',
        plot_title = 'GP-Opt: Scheduled Energy Storage Utilization',
        plot_size_inches = (18,9),
        show=  False,
    ...
    gp_runner_inst.gp_plot.plot_data_usage(
        ...
        # base_time = gp_runner_inst.scenario_params['start_utc_dt'],
        base_time = gp_runner_inst.gp_inst_planning_params['planning_start_dt'],
        # plot_title = 'GP-Fast: Scheduled Data Storage Utilization',
        plot_title = 'GP-Opt: Scheduled Data Storage Utilization',
        plot_size_inches = (18,9),
        show=  False,
