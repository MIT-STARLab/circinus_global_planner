        ...
        def filter_obs(obs_winds):
            ...
            for sat_indx in range( self.sat_params['num_sats']):
                for sat_obs_index,obs_wind in enumerate(obs_winds[sat_indx]):
                    ...
                    if obs_wind.duration.total_seconds() < self.act_timing_helper.get_act_min_duration(obs_wind):
                        continue
                    ...
                    if gp_gen.wind_in_planning_window(self,obs_wind,plan_wind_opt='mutable'):
